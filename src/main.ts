...
function getWaypoints(player: Player): Waypoint[] {
...
function saveWaypoints(player: Player, waypoints: Waypoint[]) {
...
async function showCreateMenu(player: Player) {
...
async function showTeleportMenu(player: Player) {
    const waypoints = getWaypoints(player);
...
async function showManageMenu(player: Player) {
    const waypoints = getWaypoints(player);
